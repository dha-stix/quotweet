  ...
  return (
    <section className="w-full px-8 pt-16 pb-5 lg:flex lg:flex-row min-h-[90vh] items-center bg-slate-50 flex-col ">
        <div className="flex flex-col mb-16" style={{flex:0.6}}>
            ...
            <Link to="/login" className="relative inline-flex items-center justify-start px-6 py-4 overflow-hidden font-medium transition-all bg-blue-500 rounded-xl group w-[200px] shadow-lg">
